...
def main(config_name: str, max_frames: int | None = None, num_workers: int = 8):
    ...
    if asset_id is None:
        raise ValueError("Data config must have an asset_id or repo_id to write normalization stats.")
