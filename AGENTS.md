# DEPRECATION WARNING
This public fork is deprecated for ongoing work.

- `cwatson1998/openpi` is public and should not be used as the canonical remote anymore
- the canonical repo is the private mirror: `git@github.com:cwatson1998/openpi-mirror.git`
- on every other machine, check `git remote -v` and migrate `origin` away from the public fork

If this checkout still points `origin` at the public fork, fix it now:
...
For feature branches, also retarget their upstream explicitly:
...
## Remote Policy
This public fork is maintained only as a compatibility / deprecation target.

- `origin` should not keep pointing here on active machines
- the canonical remote is the private mirror: `git@github.com:cwatson1998/openpi-mirror.git`
- if you keep this remote locally, name it `public-fork`
...
- private mirror: `git@github.com:cwatson1998/openpi-mirror.git`
- deprecated public fork: `git@github.com:cwatson1998/openpi.git`
- do new work on branches pushed to the private mirror
- do not use this public fork as the primary destination for new work
